...
class ProfileDetailsEducationCard extends StatelessWidget {
  final title;
  final subtitle;
  final startDate;
  final endDate;
  final location;
  const ProfileDetailsEducationCard({
    super.key,
    required this.title,
            ...
            children: [
              Expanded(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    SvgAssets.degree.toSVG,
                    8.toWidth,
                    Text(LocalKeys.degree, style: context.titleSmall)
                  ],
                ),
              ),
              const Expanded(
